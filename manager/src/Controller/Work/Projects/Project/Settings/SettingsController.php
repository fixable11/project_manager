...
class SettingsController extends AbstractController
{
     ...
     * @param Edit\Handler $handler Edit handler.
     *
     * @return Response
     */
     ...
     * @param Project         $project Project entity.
     * @param Request         $request Request.
     * @param Archive\Handler $handler Archive handler.
     *
     * @return Response
     */
     ...
     * @param Request           $request Request.
     * @param Reinstate\Handler $handler Handler.
     *
     * @return Response
     */
     ...
     * @param Project        $project Project.
     * @param Request        $request Request.
     * @param Remove\Handler $handler Handler.
     *
     * @return Response
     */
